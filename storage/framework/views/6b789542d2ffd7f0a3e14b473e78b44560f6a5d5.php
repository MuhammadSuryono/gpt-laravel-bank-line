...
<?php echo $__env->make('_partials.header_content',['breadcrumb'=>[ str_replace('-',' ',$menu) ]], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
         ...
         oTable = $('#list').DataTable({
                ...
                "drawCallback": function( settings ) {
                    ...
                    $('.reset').on('click', function () {
                       ...
                       var content ='<?php echo e(trans('form.user_msg_reset',['user'=>'$user'])); ?>';
                    ...
                    $('.unlock').on('click', function () {
                        ...
                        var content ='<?php echo e(trans('form.user_msg_lock',['user'=>'$user','lock'=>'Unlock'])); ?>';
...
</script><?php /**PATH C:\xampp8\htdocs\bank-line\resources\views/bank-line/MNU_GPCASH_IDM_USER/landing.blade.php ENDPATH**/ ?>