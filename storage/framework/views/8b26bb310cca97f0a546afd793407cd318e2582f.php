<?php echo $__env->make('_partials.header_content',['breadcrumb'=>['Interest Rate','detail']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="box">
                ...
                <div class="box-footer">
                            <div class="float-left">
                                ...
                                <button type="button" id="save_screen" name="save_screen" class="btn btn-default float-left" style="display:none" onclick="save_pdf();"><?php echo app('translator')->get('form.save_pdf'); ?></button>
                            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        function submit_delete () {
            ...
            $.ajax({
                url: 'delete',
                method: 'post',
                data: {"_token": "<?php echo e(csrf_token()); ?>", menu: id, value: value,url_action:'submit'},
    ...
    function getDetail(){
        ...
        $.ajax({
            url: 'getAPIData',
            method: 'post',
            data:{value:value,menu:id,action:'DETAIL',url_action:url_action, _token : '<?php echo e(csrf_token()); ?>'},
            success: function (data) {
                var result = JSON.parse(data);
...
</script><?php /**PATH D:\Downloads\Upgrade Laravel Framework\bank-line\resources\views/bank-line/MNU_GPCASH_MT_INTEREST_RATE/detail.blade.php ENDPATH**/ ?>