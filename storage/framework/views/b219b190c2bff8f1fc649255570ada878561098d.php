<?php echo $__env->make('_partials.header_content',['breadcrumb'=>['Corporate Registration Report','Search']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    function requestDownload(fileFormat) {
        ...
        $('.row-corporate').validator('validate');
            ...
            // if($('.row-corporate').validator('validate').has('.help-block').length==0) {
...
</script><?php /**PATH C:\xampp8\htdocs\bank-line\resources\views/bank-line/MNU_GPCASH_BO_RPT_CORP_REGIS/landing.blade.php ENDPATH**/ ?>