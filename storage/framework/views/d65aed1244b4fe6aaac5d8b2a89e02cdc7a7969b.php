<?php echo $__env->make('_partials.header_content',['breadcrumb'=>['Institution','Search']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title">Institution Filter</h3>
                </div>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-header list-title">
                        <h3 class="box-title">Institution Listing</h3>
                    </div>
                    <div class="box-body list-title">
                                ...
                                <table id="list" class="table table-bordered table-striped dataTable" border="2" cellpadding="2"
                                    ...
                                    <thead>
                                    <tr>
                                        <th align="center"><strong>Institution Code</strong></th>
                                        <th align="center"><strong>Institution Name</strong></th>
										<th align="center"><strong>Institution Name English</strong></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
...
</script><?php /**PATH C:\xampp8\htdocs\bank-line\resources\views/bank-line/MNU_GPCASH_MT_INST/landing.blade.php ENDPATH**/ ?>