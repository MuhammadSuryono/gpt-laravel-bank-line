        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Language Mapping Filter</h3>
                </div>
                    ...
                    <div class="container-fluid">
						...
						<div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="nameId" name="name" class="form-control" autocomplete="off" value="" maxlength="100">
                ...
                <div class="box-footer">
                    ...
                    <div class="box-header list-title">
                        <h3 class="box-title">Language Mapping Listing</h3>
                    </div>
                           ...
                           <div class="row">
                                <table id="list" class="table table-bordered table-striped dataTable" border="2" cellpadding="2"
                                    ...
                                    <tr>
                                        ...
                                        <th align="center"><strong>English Language</strong></th>
										<th align="center"><strong>Local Language</strong></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
...
</script><?php /**PATH D:\Downloads\Upgrade Laravel Framework\bank-line\resources\views/bank-line/MNU_GPCASH_MT_HOST_ERROR_MAPPING/landing.blade.php ENDPATH**/ ?>