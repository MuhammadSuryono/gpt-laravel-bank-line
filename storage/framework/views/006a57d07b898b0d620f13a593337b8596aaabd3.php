        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Cheque Filter</h3>
                </div>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-header list-title">
                        <h3 class="box-title">Cheque Listing</h3>
                    </div>
    ...
    $(document).ready(function () {
        ...
        $('#search').on('click', function () {
         ...
         $('#list tbody').on('click', 'a', function (e) {
            ...
            var orderNo_id = $(this).data('code');			
            if (orderNo_id !== undefined) {
                var res = app.setView(id,'detail');
                if(res=='done'){
                    $('#orderNo_id').val(orderNo_id);
                    getDetail();
                }
            }
        });
...
</script><?php /**PATH D:\Downloads\Upgrade Laravel Framework\bank-line\resources\views/bank-line/MNU_GPCASH_CHQ_STS/landing.blade.php ENDPATH**/ ?>