        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Menu Setup Filter</h3>
                </div>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-header list-title">
                        <h3 class="box-title">Menu Setup Listing</h3>
                    </div>
                        ...
                        <div class="container-fluid">
                           <div class="row">
                                <table id="list" class="table table-bordered table-striped dataTable" border="2" cellpadding="2"
                                    ...
                                    <thead>
                                    <tr>
                                        <th align="center"><strong>Menu Setup Code</strong></th>
                                        <th align="center"><strong>Menu Setup Name</strong></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
...
</script><?php /**PATH C:\xampp8\htdocs\bank-line\resources\views/bank-line/MNU_GPCASH_PRO_MNU_PC/landing.blade.php ENDPATH**/ ?>