<?php echo $__env->make('_partials.header_content',['breadcrumb'=>['Virtual Account','Search']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    $(document).ready(function () {
                ...
                "columnDefs": [
                    {
                        ...
                        data: {
                            ...
                            cifId:"cifId",
                            vaStatus: "vaStatus",
                            vaProductCode: "vaProductCode"
                        },
                        render: function ( data, type, full, meta ) {
                            return '<a href="javascript:void(0)" data-cifid="'+data.cifId+'" data-code="'+data.corporateId+'" data-status="'+data.vaStatus+'" data-product-code="'+data.vaProductCode+'">'+data.corporateId+'</a>';
                        },
                        orderable: true
                    },
                    {
        ...
        $('#list tbody').on('click', 'a', function (e) {
            ...
            var corpCode = $(this).data('productCode');
...
</script><?php /**PATH C:\xampp8\htdocs\bank-line\resources\views/bank-line/MNU_GPCASH_CORP_VA/landing.blade.php ENDPATH**/ ?>