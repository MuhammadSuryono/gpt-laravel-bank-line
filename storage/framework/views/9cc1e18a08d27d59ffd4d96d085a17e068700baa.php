<?php echo $__env->make('_partials.header_content',['breadcrumb'=>['Cheque Order Report','Search']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <div class="container-fluid">
                            <div class="row">
								<div class="form-group">
									...
									<div class="col-md-6">
										<select class="form-control" id="branch" data-error="please select corporate" required>
							...
							<div class="row">
								<div class="form-group">
									<label class="col-md-2 control-label"><strong>Order Date</strong></label>
									<div class="col-md-6">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    unitOption = '<option value="">select Branch</option>';
...
</script><?php /**PATH C:\xampp8\htdocs\bank-line\resources\views/bank-line/MNU_GPCASH_BO_RPT_CHQ_ORDER/landing.blade.php ENDPATH**/ ?>