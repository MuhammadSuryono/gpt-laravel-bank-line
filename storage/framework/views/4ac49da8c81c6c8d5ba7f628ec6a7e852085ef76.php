...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#edit').on('click', function () {
            if(countMenu()==0){
                var content ='<?php echo e(trans('form.alert_noselect',['label'=>'Services'])); ?>';
                $.alert({
...
</script><?php /**PATH C:\xampp8\htdocs\bank-line\resources\views/bank-line/MNU_GPCASH_BANK_TRX_LMT/landing.blade.php ENDPATH**/ ?>