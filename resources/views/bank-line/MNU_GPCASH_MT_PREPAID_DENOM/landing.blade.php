@include('_partials.header_content',['breadcrumb'=>['Prepaid Denomination','Search']])
        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title">Denomination Filter</h3>
                </div>
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-2 control-label">Denomination Name</label>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-header list-title">
                        <h3 class="box-title">Denomination Listing</h3>
                    </div>
                    <div class="box-body list-title">
                                ...
                                <table id="list" class="table table-bordered table-striped dataTable" border="2" cellpadding="2"
                                    ...
                                    <thead>
                                    <tr>
                                        <th align="center"><strong>Package Code</strong></th>
                                        <th align="center"><strong>Denomination Name</strong></th>
                                        <th align="center"><strong>Denomination Value</strong></th>
                                        <th align="center"><strong>Denomination Type</strong></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
