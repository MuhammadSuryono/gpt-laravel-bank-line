@include('_partials.header_content',['breadcrumb'=>['Prepaid Denomination','detail']])
        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title">Denomination Detail</h3><br>
                </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <label id="denomination">-</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-2 control-label">Denomination Type</label>
                                <div class="col-md-6">
                                    <label id="denomType">-</label>
                                </div>
                            </div>
                        </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    ...
                    $('#denomination').text(detail.denomination);
                    $('#denomType').text(detail.denomTypeCode + ' - ' + detail.denomTypeName);
                } else {
                    flash('warning', result.message);
                }
