@include('_partials.header_content',['breadcrumb'=>['Ongoing task','Prepaid Denomination Detail']])
            ...
            <form class="form-horizontal">
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-2 control-label">Denomianation Name</label>
                                <div class="col-md-6">
                                    <label id="name">-</label>
                                </div>
                            </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    ...
                    $('#denomType').text(detail.denomTypeName);
                } else {
