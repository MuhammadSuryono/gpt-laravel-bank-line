@include('_partials.header_content',['breadcrumb'=>['Ongoing task','Transaction Limit Detail']])
        ...
        <div class="col-xs-12">
            ...
            <form class="form-horizontal">
                ...
                <div class="box-body">
                    ...
                    <div class="box-header">
                        <h3 class="box-title table-hidden">Transaction Limit per Day per Customer</h3>
                    </div>
                    <div class="box-body">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    var detail = result.details.customerLimitList;
