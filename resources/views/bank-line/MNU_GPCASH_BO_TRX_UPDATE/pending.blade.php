@include('_partials.header_content',['breadcrumb'=>['Ongoing task','Transaction Update']])
            ...
            <div class="box-header">
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-2 control-label">Transaction Reference Number</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-2 control-label">Transaction Update Status</label>
                                <div class="col-md-6">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    $('#menuName').text(result.details.menuName);
