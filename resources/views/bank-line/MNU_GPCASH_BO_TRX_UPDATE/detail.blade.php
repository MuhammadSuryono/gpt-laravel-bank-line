@include('_partials.header_content',['breadcrumb'=>['Transaction Update Listing','detail']])
...
<script>
    ...
    function updateTransactionSubmit(status){
        ...
        $.ajax({
            url: 'getAPIData',
            method: 'post',
            data: {"_token": "{{ csrf_token() }}", action:action,url_action:url_action,menu: service, value: value},
            success: function (data) {
                $('#confirm').prop('disabled',false);
