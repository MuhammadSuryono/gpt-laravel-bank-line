@include('_partials.header_content',['breadcrumb'=>['Ongoing task','Special Rate Detail']])
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    ...
                    $('#customer').text(detail.customerId);
                    ...
                    $('#specialRate').text(detail.buySellRateOpt + " : " + detail.buySellRate);
                    $('#buySellAmountRate').text(detail.buySellAmountRate);
                    $('#transactionBuyRate').text(detail.sellRate);
                    $('#transactionSellRate').text(detail.buyRate);
                    $('#transactionAmountRate').text(detail.trxAmount);
                    $('#type').text(detail.typeRate);
                    $('#expiryDate').text(detail.expiryDate + " " + detail.expHour);
