                    ...
                    <div class="container-fluid">
						...
						<div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="organizationUnitCode" name="organizationUnitCode" class="form-control state_edit" autocomplete="off" value="" maxlength="100" data-error="This field is required." required>
                                    <div class="help-block with-errors"></div>
						...
						<div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="memberCode" name="memberCode" class="form-control state_edit" autocomplete="off" value="" maxlength="100" data-error="This field is required." required>
                                    <div class="help-block with-errors"></div>
						...
						<div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="interBankCode" name="interBankCode" class="form-control state_edit" autocomplete="off" value="" maxlength="100">
                                    <div class="help-block with-errors"></div>
