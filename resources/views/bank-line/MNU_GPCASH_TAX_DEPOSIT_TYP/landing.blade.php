@include('_partials.header_content',['breadcrumb'=>['Deposit Type','Search']])
        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title">Deposit Filter</h3>
                </div>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-header list-title">
                        <h3 class="box-title">Deposit Listing</h3>
                    </div>
                    <div class="box-body list-title">
                                ...
                                <table id="list" class="table table-bordered table-striped dataTable" border="2" cellpadding="2"
                                    ...
                                    <thead>
                                    <tr>
                                        <th align="center"><strong>Deposit Code</strong></th>
                                        <th align="center"><strong>Deposit Name</strong></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
