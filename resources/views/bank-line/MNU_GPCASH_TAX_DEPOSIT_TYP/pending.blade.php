@include('_partials.header_content',['breadcrumb'=>['Ongoing task','Deposit Detail']])
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    ...
                    $('#taxDepositType').text(detail.taxDepositCode);
                    $('#taxType').text(detail.taxTypeName);
                } else {
