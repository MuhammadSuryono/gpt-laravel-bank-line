           ...
           <div class="box-header">
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-4 control-label lblcorpID"><strong>customer ID&ast;</strong></label>
                                <div class="col-md-5">
                                    <div class="customer_setup state_edit"><select class="form-control"></select></div>
    ...
    function getCustomer() {
        ...
        $.ajax({
            ...
            success: function (data) {
                var result = JSON.parse(data);
                if (result.status=="200") {
                    unitOption = '<select id="customer_list" class="form-control state_edit" data-error="customer is mandatory" required>';
                    ...
                    $('.customer_setup').html(unitOption);
