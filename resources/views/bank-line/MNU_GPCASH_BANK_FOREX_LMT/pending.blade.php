@include('_partials.header_content',['breadcrumb'=>['Ongoing task','Bank Forex Limit']])
                ...
                <div class="box-header">
                    ...
                    <h3 class="box-title addState">Bank Forex Limit Detail</h3><br>
                      ...
                      <div class="box-body">
                        ...
                        <div class="container-fluid addState">
                            <div class="row">
                                <div class="form-group">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Minimum Buy Limit in IDR</label>
                                    <div class="col-md-6">
                                        <label id="minBuyLimit" class="rate">-</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Maximum Buy Limit in IDR</label>
                                    <div class="col-md-6">
                                        <label id="maxBuyLimit" class="rate">-</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Minimum Sell Limit in IDR</label>
                                    <div class="col-md-6">
                                        <label id="minSellLimit" class="rate">-</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Maximum Sell Limit in IDR</label>
                                    <div class="col-md-6">
                                        <label id="maxSellLimit" class="rate">-</label>
                                    </div>
                                </div>
                            </div>
                        </div>      
                ...
                if (result.status=="200") {
                    ...
                    $.each(detail, function (idx, obj){
                        ...
                        if (viewState == 'ADD') {
                            ...
                            $('#currency').text(obj.currencyView);
                            $('#minBuyLimit').text(obj.minBuyLimit);
                            $('#maxBuyLimit').text(obj.maxBuyLimit);
                            $('#minSellLimit').text(obj.minSellLimit);
                            $('#maxSellLimit').text(obj.maxSellLimit);
