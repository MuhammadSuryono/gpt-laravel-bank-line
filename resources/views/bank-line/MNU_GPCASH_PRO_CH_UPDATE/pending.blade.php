@include('_partials.header_content',['breadcrumb'=>['Ongoing task','Fee Updates Detail']])
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal">
                ...
                <div class="box-header">
                    <h3 class="box-title">Fee Updates</h3><br>
                </div>
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-3 control-label">Fee Updates</label>
                                <div class="col-md-6">
                                    <label id="updateType">-</label>
                                </div>
                            </div>
                        </div>
                        <div class="row specialFee">
                            <div class="form-group">
                    ...
                    <div class="box-header">
                        <h3 class="box-title table-hidden">Fee Setup Detail</h3>
                    </div>
                    <div class="box-body">
