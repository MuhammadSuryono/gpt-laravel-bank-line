@include('_partials.header_content',['breadcrumb'=>['Ongoing task','Approval Mechanism Detail']])
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal">
                ...
                <div class="box-header">
                    <h3 class="box-title">Approver Mechanism Detail</h3><br>
                </div>
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-2 control-label">Bank Approval Matrix Menu</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-2 control-label">Number of Approver</label>
                                <div class="col-md-6">
                                    <label id="noOfApprover">-</label>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    ...
                    var appMatrixList = detail.bankApprovalMatrixDetailList;

                    $('#menuCode').text(detail.approvalMatrixMenuCode + " - " + detail.approvalMatrixMenuName);
                    $('#noOfApprover').text(detail.noOfApprover);

                    if (appMatrixList) {
                        $.each(appMatrixList, function (idx, obj){
                            oTable.row.add([
                                idx+1,
                                obj.noOfUser,
                                obj.approvalLevelCode + " - " + obj.approvalLevelName,
                                obj.branchOptName
                            ]).draw(true);
                        });
                    }
