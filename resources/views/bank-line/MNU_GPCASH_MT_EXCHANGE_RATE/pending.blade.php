@include('_partials.header_content',['breadcrumb'=>['Ongoing task','Exchange Rate Detail']])
            ...
            <form class="form-horizontal">
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-2 control-label">Transaction Buy Rate</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-2 control-label">Transaction Mid Rate</label>
                                <div class="col-md-6">
                                    <label id="trxMidRate" class="rate">-</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-2 control-label">Transaction Sell Rate</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-2 control-label">Bank Note Sell Rate</label>
                                <div class="col-md-6">
                                    <label id="bankSellRate" class="rate">-</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-2 control-label">Bank Note Buy Rate</label>
                                <div class="col-md-6">
                                    <label id="bankBuyRate" class="rate">-</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-2 control-label">Teller Sell Rate</label>
                                <div class="col-md-6">
                                    <label id="tellerSellRate" class="rate">-</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-2 control-label">Teller Buy Rate</label>
                                <div class="col-md-6">
                                    <label id="tellerBuyRate" class="rate">-</label>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    ...
                    $('#trxBuyRate').text(detail.trxBuyRate);
                    $('#trxMidRate').text(detail.trxMidRate);
                    $('#trxSellRate').text(detail.trxSellRate);
