@include('_partials.header_content',['breadcrumb'=>['fee setup','detail']])
        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="box-header">
                        <h3 class="box-title table-hidden">Fee Setup Listing</h3>
                    </div>
                    <div class="box-body">
...
<script>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    ...
                    var detail = result.result[index].transactionChargeList;
    ...
    function getTableData() {
        ...
        $("#list").find("tbody tr").each(function () {
            ...
            var service_charge_name = $('td:eq(1)', $(this)).text();
            var curr_code = $('td:eq(2)', $(this)).text();
            var value = $('td:eq(3)', $(this)).text();
