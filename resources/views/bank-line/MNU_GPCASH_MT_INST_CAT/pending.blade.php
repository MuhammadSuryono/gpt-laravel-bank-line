@include('_partials.header_content',['breadcrumb'=>['Ongoing task','Institution Category Detail']])
            ...
            <form class="form-horizontal">
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-4 control-label">Activity Date Time</label>
                                <div class="col-md-6">
                ...
                <div class="box-header">
                    <h3 class="box-title">Institution Category Detail</h3><br>
                </div>
