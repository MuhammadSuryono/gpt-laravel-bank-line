    ...
    <div class="row">
        <div class="col-xs-12">
           ...
           <div class="box-header">
                     <h3 class="box-title">Institution Category Setup Detail</h3>
                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-4 control-label"><strong>Institution Category Code&ast;</strong></label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-4 control-label"><strong>Institution Category Name &ast;</strong></label>
                                <div class="col-md-6">
						...
						<div class="row">
                            <div class="form-group">
                                <label class="col-md-4 control-label"><strong>Institution Category Name English&ast;</strong></label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-4 control-label"><strong>Description&ast;</strong></label>
                                <div class="col-md-6">
...
<script>
    ...
    function getInstitutionCatEdit(code_id){
