                    ...
                    <div class="box-body list-title">
                        ...
                        <div class="box-footer">
                            ...
                            <div class="float-right">
                                ...
                                <button type="button" id="edit" name="edit" class="btn btn-primary">@lang('form.edit_domestic_bank')</button>
                                <button type="button" id="edit_city" name="edit_city" class="btn btn-primary">@lang('form.edit_city')</button>
