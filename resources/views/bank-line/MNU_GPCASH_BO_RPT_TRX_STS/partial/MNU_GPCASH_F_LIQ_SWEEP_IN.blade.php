            ...
            <input type="hidden" id="referenceNo" value=""/>
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-5 control-label">Auto Sweep Back</label>
                                <div class="col-md-6">
                                    <label id="sweepBack">-</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-5 control-label">Remaining Amount Type</label>
                                <div class="col-md-6">
                    ...
                    <table id="subAcctList" class="table table-bordered table-striped dataTable" border="2" cellpadding="2" style="border-collapse:collapse;">
                        <thead>
                            <tr>
                                ...
                                <th align="center"><strong>Remaining Amount</strong></th>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    ...
                    $('#sweepBack').text(confirm_data.auto_sweep_back);
