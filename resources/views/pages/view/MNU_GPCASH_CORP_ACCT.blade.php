@include('_partials.header_content',['breadcrumb'=>['Corporate Account']])
            ...
            <div class="box">
                ...
                <div class="box-footer">
                    ...
                    <div class="box-header list-title">
                        <h3 class="box-title">Account Group Listing</h3>
                    </div>
                        ...
                        <div class="container-fluid">
                           <div class="row">
                                <table id="list" class="table table-bordered table-striped dataTable" border="2" cellpadding="2"
                                    ...
                                    <thead>
                                    <tr>
                                        <th align="center"><strong>Group Code</strong></th>
                                        <th align="center"><strong>Group Name</strong></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
