@include('_partials.header_content',['breadcrumb'=>['fee setup']])
        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title">Fee Setup Search</h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="box-header list-title">
                        <h3 class="box-title">Fee Setup Listing</h3>
                    </div>
                        ...
                        <div class="box-body">
                           <div class="row">
                                <table id="list" class="table table-bordered table-striped dataTable" border="2" cellpadding="2"
                                    ...
                                    <thead>
                                    <tr>
                                        <th align="center"><strong>Fee Setup Code</strong></th>
                                        <th align="center"><strong>Fee Setup Name</strong></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
